        ...
        <div className="public-page-container">
          ...
          <div style={{
            ...
            <div className="glass-card glass-card--center">
              ...
              <h3 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "0.5rem", color: "white" }}>Email Us</h3>
            ...
            <div className="glass-card glass-card--center">
              ...
              <h3 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "0.5rem", color: "white" }}>Visit Us</h3>
              <p className="glass-card__desc" style={{ marginBottom: "1.5rem" }}>
